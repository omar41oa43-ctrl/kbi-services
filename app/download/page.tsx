...
export default function DownloadAppPage() {
  ...
  const apkDownloadUrl = 'https://github.com/omar41oa43-ctrl/kbi-services/releases/download/v1.4.4/kbi-technician.apk';
  ...
  return (
    <div className="adaptive-theme-page min-h-screen bg-[#030405] text-white flex flex-col items-center justify-center p-4 sm:p-6 selection:bg-[#1ECBC7] selection:text-black">
      ...
      <div className="relative z-10 max-w-lg w-full bg-slate-900/80 border border-slate-800 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 shadow-2xl">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-[#1ECBC7] p-0.5 shadow-lg shadow-[#1ECBC7]/20 mb-4">
            <div className="w-full h-full bg-slate-950 rounded-2xl flex items-center justify-center">
              <span className="font-extrabold text-2xl tracking-tighter">
                KBI<span className="text-[#1ECBC7]">.</span>
              </span>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <a
            href={apkDownloadUrl}
            className="w-full flex items-center justify-center gap-3 bg-[#1ECBC7] hover:bg-[#35ddd9] active:scale-[0.98] text-[#030405] font-bold py-4 px-6 rounded-2xl shadow-lg shadow-[#1ECBC7]/25 transition-all"
          >
        ...
        <div className="mt-6 rounded-2xl border border-[#1ECBC7]/20 bg-[#1ECBC7]/10 p-4">
          <h2 className="text-sm font-bold text-[#1ECBC7]">What&apos;s new in v1.4.4</h2>
          <ul className="mt-2 space-y-1 text-xs text-slate-300 list-disc list-inside">
            <li>Faster, clearer dark interface across the full technician workflow</li>
            <li>Reliable acceptance, rejection, completion, notes, and notification sync</li>
            <li>Improved live GPS, offline recovery, and duplicate-order handling</li>
            <li>Production security, privacy, and Google Play compatibility updates</li>
          </ul>
        </div>
        ...
        <div className="mt-6 pt-5 border-t border-slate-800/80 text-left space-y-3">
          ...
          <ul className="text-xs text-slate-400 space-y-2 list-disc list-inside">
            <li>
              <strong className="text-slate-200">Android:</strong> Tap <span className="text-[#1ECBC7]">Download</span>. When prompted, allow <em>"Install from Unknown Sources"</em> or <em>"Download anyway"</em>.
            </li>
            <li>
