          ...
          >
            ...
            <div className="flex justify-center mb-10">
              <motion.div 
                ...
                className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white/5 border border-white/10 cursor-default hover:bg-white/10 transition-all duration-300"
              >
            ...
            {/* Headings */}
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white via-blue-50 to-white/60 mb-6 tracking-tighter text-balance leading-[1.1]" suppressHydrationWarning>
              <span>{t("We Come to You")}<br /><span className="text-blue-400 inline-block mt-2">{t("Best On-Site Repair in Abu Dhabi")}</span></span>
            </h1>

            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed font-light tracking-wide" suppressHydrationWarning>
