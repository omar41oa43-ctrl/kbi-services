...
const DICTIONARY: Record<string, string> = {
  ...
  "Premier on-site technology repair and IT solutions delivered directly to your home or workplace across all 7 Emirates. Certified specialists, precision-grade components, and prompt same-day service throughout the UAE.": "حلول صيانة تقنية ودعم فني متكامل يُقدَّم مباشرة في موقعك عبر كافة إمارات الدولة السبع. نخبة من الفنيين المعتمدين، قطع غيار عالية الجودة، وخدمة سريعة في نفس اليوم أينما كنت في الإمارات.",
