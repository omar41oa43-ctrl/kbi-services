...
const DICTIONARY: Record<string, string> = {
  ...
  "Professional repair and IT services across Abu Dhabi, Dubai, Sharjah & Ajman. We come to your home or office with genuine parts and same-day service.": "خدمات صيانة وإصلاح تقنية احترافية في أبوظبي، دبي، الشارقة وعجمان. نصلك إلى منزلك أو مكتبك مع قطع أصلية وخدمة في نفس اليوم.",
