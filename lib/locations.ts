...
export const locations: LegacyLocation[] = [
  {
    ...
    name: "Abu Dhabi",
    nameAr: "أبوظبي",
    description: "Professional on-site phone, laptop, computer, printer, TV and IT support across Abu Dhabi. KBI technicians come directly to your home or office.",
  ...
  },
  {
    ...
    name: "Dubai",
    nameAr: "دبي",
    description: "Professional on-site phone, laptop, computer, printer, TV and IT support in Dubai. KBI technicians come directly to your home or office.",
  ...
  },
  {
    ...
    name: "Sharjah",
    nameAr: "الشارقة",
    description: "Professional on-site device diagnosis, repair and IT support appointments across Sharjah.",
  ...
  },
  {
    ...
    name: "Ajman",
    nameAr: "عجمان",
    description: "Professional doorstep mobile, laptop, electronics repair and IT support anywhere in Ajman.",
  ...
  },
  {
    ...
    name: "Ras Al Khaimah",
    nameAr: "رأس الخيمة",
    description: "Professional on-site device repair, laptop servicing and IT support across Ras Al Khaimah.",
    landmarks: ["Al Nakheel", "Al Hamra Village", "RAK City", "Corniche"],
  },
  {
    id: "fujairah",
    slug: "fujairah",
    name: "Fujairah",
    nameAr: "الفجيرة",
    description: "Professional on-site technology and electronics repair services throughout Fujairah.",
    landmarks: ["Fujairah City", "Dibba Al-Fujairah", "Corniche"],
  },
  {
    id: "umm-al-quwain",
    slug: "umm-al-quwain",
    name: "Umm Al Quwain",
    nameAr: "أم القيوين",
    description: "Professional doorstep device diagnosis, hardware repair and IT support across Umm Al Quwain.",
    landmarks: ["UAQ City", "Al Salamah", "Corniche"],
  },
  {
    id: "yas-island",
    slug: "yas-island",
    name: "Yas Island",
    nameAr: "جزيرة ياس",
    description: "Professional on-site device repair and IT solutions in Yas Island, Abu Dhabi, UAE.",
    landmarks: ["Yas Mall", "Yas Marina", "Yas Bay", "Yas Waterworld"],
  },
  {
    id: "khalifa-city",
    slug: "khalifa-city",
    name: "Khalifa City",
    nameAr: "مدينة خليفة",
    description: "On-site tech repair and IT support services in Khalifa City, Abu Dhabi, UAE.",
  ...
  },
  {
    ...
    name: "Al Reem Island",
    nameAr: "جزيرة الريم",
    description: "Doorstep device maintenance for residential towers in Al Reem Island, Abu Dhabi, UAE.",
  ...
  },
  {
    ...
    name: "Dubai Marina",
    nameAr: "دبي مارينا",
    description: "On-site mobile and laptop service appointments in Dubai Marina, Dubai, UAE.",
  ...
  },
  {
    ...
    description: "Doorstep repairs in Downtown Dubai, Burj Khalifa area, and Business Bay, Dubai, UAE.",
